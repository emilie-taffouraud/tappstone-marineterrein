...
WATER_DB_PASSWORD=
WATER_DB_SSL=false
AIR_QUALITY_DATABASE_URL=
AIR_QUALITY_DB_HOST=
AIR_QUALITY_DB_PORT=5432
AIR_QUALITY_DB_NAME=
AIR_QUALITY_DB_USER=
AIR_QUALITY_DB_PASSWORD=
AIR_QUALITY_DB_SSL=false
AIR_QUALITY_MQTT_TABLE=mqtt_consumer
AIR_QUALITY_DEVICE_PREFIX=MT
AIR_QUALITY_LOOKBACK_ROWS=500
...
- `AIR_QUALITY_DATABASE_URL` or the separate `AIR_QUALITY_DB_*` values for MQTT air-quality data
